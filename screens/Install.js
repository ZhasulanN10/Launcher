...
export default function Install({navigation}) {
  ...
  const _downloadFileProgress = (data) => {
    ...
    switch (download_state) {
      case 1: {
        messageInformation = 'Загрузка кэша игры...';
        break;
      }
      case 2: {
        messageInformation = 'Загрузка текстур игры...';
        break;
      }
      case 3: {
        messageInformation = 'Загрузка клиента игры...';
        break;
      }
    }
    setProgress(percentage);
    setTextState(messageInformation);
